...
async function main() {
  ...
  const nftContract = await hre.ethers.deployContract("MonkeyPicsNFT");
  await nftContract.waitForDeployment();
  console.log("MonkeyPicsNFT deployed to:", nftContract.target);
  ...
  const amount = hre.ethers.parseEther("0.2"); // Fund the DAO with 0.2 ETH
  ...
  console.log("MonkeyPicsDAO deployed to:", daoContract.target);
